...
interface AButtonProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
...
export function AButton({ children, className, variant, icon, split, ...rest }: AButtonProps) {
    return (
        <a
        ...
        >
            ...
            {split ? (
                ...
                children && (<div className="hidden md:flex-auto md:inline-block md:whitespace-nowrap md:text-center">
                    {children}
                </div>)
            ) : children}
        </a>
